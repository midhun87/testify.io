...
app.get('/api/public/reports/:email', async (req, res) => {
    try {
        ...
        // Using DynamoDB Scan to find results (Replace with QueryCommand if you have an index on studentEmail)
        ...
        // Map results to only return safe, non-sensitive data for public viewing
        ...
        publicReports.sort((a, b) => new Date(b.submittedAt) - new Date(a.submittedAt));
